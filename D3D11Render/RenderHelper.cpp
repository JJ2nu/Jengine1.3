...
HRESULT CompileShaderFromFile(const WCHAR* szFileName, LPCSTR szEntryPoint, LPCSTR szShaderModel, ID3DBlob** ppBlobOut, D3D_SHADER_MACRO macros[])
{
	HRESULT hr = S_OK;
	...
	hr = D3DCompileFromFile(szFileName, macros, D3D_COMPILE_STANDARD_FILE_INCLUDE, szEntryPoint, szShaderModel,
